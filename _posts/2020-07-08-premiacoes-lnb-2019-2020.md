...
======  
 ...
 ![graphic2](../images/lucas dias shot chart.png)
   ...
   Os pivôs estão também associados a última linha de defesa de um time, de modo que o pivô deve ter o maior número de rebotes e tocos de um time. Mas defesa é muito mais que apenas tocos, rebotes e roubadas de bola. 
