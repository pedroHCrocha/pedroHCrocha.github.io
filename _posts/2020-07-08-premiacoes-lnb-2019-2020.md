...
| Hettsheimeir #30 | Franca      | 23 | 1.4657 | 51.769 | 12.782 | 5.130 | 0.391 |
  ...
  Podemos comparar as características ofensivas dos pivôs. Como tradicionalmente a posição 5 ataca mais dentro do garrafão, enquanto que a ala-pivô possui uma conjunto ofensivo mais diversificado, a estatísica mais apropriada para comparar os dois estilos é a **effective field goal percentage (EFG)**, mas para embasar a ideia de eficiência do jogador, olhamos a própria estatística, adicionando os rebotes e tocos na análise. Olhando para esses dados, vemos que Scott #22 é um dos candidatos com mais argumentos para preencher uma das vagas da categoria.  
